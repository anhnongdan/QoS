 ...
 */
class ExampleEvolution extends Base
{
    protected function init()
    {
        parent::init();

//        $this->name          = Piwik::translate('MyPlugin_LastVisitsByBrowser');
//        $this->dimension     = null;
...
//        $this->order = 1;
        ...
        $this->metrics       = array('nb_visits', 'nb_uniq_visitors', 'nb_hits');
...
//        $this->constantRowsCount = true;
        ...
        // $this->menuTitle    = 'MyPlugin_LastVisitsByBrowser';
        ...
        // $this->widgetTitle  = 'MyPlugin_LastVisitsByBrowser';
//        $this->widgetTitle = 'Real-time Reports';
    ...
    {
    $view = new View('@MyPlugin/getLastVisitsByBrowser');
    $view->myData = array();
